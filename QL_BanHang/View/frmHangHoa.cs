...
namespace QL_BanHang.View
{
    public partial class frmHangHoa : Form
    {
        ...
        {
            DialogResult dr = MessageBox.Show("Bạn chắc chắn muốn xóa hàng hóa này?", "Xác nhận xóa", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
